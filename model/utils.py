...
def statistical_tests(
    benchmark_results: dict[str, list[BenchmarkResult]], to_latex: bool = False
) -> None:
    ...
    **Returns**:
    ...
    statistical_data = {
        ...
        arg: _py.group_by(arg_results, _get_values)
    ...
    if to_latex is False:
        ...
        with open("tukey_results.tex", "w", encoding="utf-8") as file:
            file.write(
                pd.concat(
                    [
                        df.assign(Function=function).reindex(
                            columns=[
